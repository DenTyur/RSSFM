...
impl Xspace3D {
    ...
    pub fn new(x0: [F; Self::DIM], dx: [F; Self::DIM], n: [usize; Self::DIM]) -> Self {
        ...
        let mut grid: [Array1<F>; Self::DIM] =
            [Array1::default(0), Array1::default(0), Array1::default(0)];
        for i in 0..Self::DIM {
...
impl Space<3> for Xspace3D {
    ...
    fn load_from_npy(dir_path: &str) -> Self {
        let mut grid: [Array1<F>; Self::DIM] =
            [Array1::default(0), Array1::default(0), Array1::default(0)];
        let mut x0: [F; Self::DIM] = [0.0, 0.0, 0.0];
        let mut dx: [F; Self::DIM] = [0.0, 0.0, 0.0];
        let mut n: [usize; Self::DIM] = [0, 0, 0];
...
impl Pspace3D {
    ...
    pub fn init(x: &Xspace3D) -> Self {
        let mut p0: [F; Self::DIM] = [0.0, 0.0, 0.0];
        let mut dp: [F; Self::DIM] = [0.0, 0.0, 0.0];
        let mut n: [usize; Self::DIM] = [0, 0, 0];
        for i in 0..Self::DIM {
            p0[i] = -PI / x.dx[i];
            n[i] = x.n[i];
