...
use crate::traits::ssfm_in_imaginary_time::{
    GaugedEvolutionSSFMinImaginaryTime, SSFMinInaginaryTime,
};
use crate::traits::wave_function::WaveFunction;

pub struct SSFM1DinInaginaryTime<'a, G>
where
    G: GaugedEvolutionSSFMinImaginaryTime<1, WF = WaveFunction1D>,
{
...
impl<'a, G> SSFM1DinInaginaryTime<'a, G>
where
    G: GaugedEvolutionSSFMinImaginaryTime<1, WF = WaveFunction1D>,
{
    pub fn new(
...
impl<'a, G> SSFMinInaginaryTime for SSFM1DinInaginaryTime<'a, G>
where
    G: GaugedEvolutionSSFMinImaginaryTime<1, WF = WaveFunction1D>,
{
