...
pub trait GaugedEvolutionSSFMinImaginaryTime<const D: usize> {
    type WF;
...
pub trait GaugedEvolutionSSFMinImaginaryTimeTwoParticles<const D: usize> {
...
pub trait SSFMinInaginaryTime {
    ...
    fn time_step_evol(
        ...
        psi: &mut Self::WF,
        t: &mut Tspace,
        momentum_representation_callback: Option<&mut dyn FnMut(&Self::WF, &Tspace)>,
    );
}
